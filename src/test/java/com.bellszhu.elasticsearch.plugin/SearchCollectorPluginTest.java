...
import com.bellszhu.elasticsearch.plugin.ingest.CacheWriterIngestPlugin;
import com.bellszhu.elasticsearch.plugin.search.collector.ExampleRescoreBuilder;
import com.bellszhu.elasticsearch.plugin.search.collector.SearchCollectorPlugin;
 ...
 */
@Slf4j
public class SearchCollectorPluginTest {
...
//    private RestHighLevelClient client;
    ...
    public void setUp() {
        ...
        runner.build(newConfigs()
                        ...
                        .clusterName("test")
                        .baseHttpPort(9201)
                                .pluginTypes("com.bellszhu.elasticsearch.plugin.action.CustomCachePlugin")
